...
const STAGE_NARRATIVES = {
  EGG: [
    ...
    { hour: 1,  text: '◎ 뒤를 보는 이는 없다. 뒤는 이미 없어졌다.' },
    { hour: 3,  text: '◎ 칼라릴리호가 닻을 올린다. 목적지는 꽃잎 안에 있다.' },
    { hour: 6,  text: '◎ 관리자는 기록한다 — 포장 상태 양호.' },
    { hour: 9,  text: '◎ 처음 맡아보는 냄새의 식사. 낯설어서 서러운 맛.' },
    { hour: 12, text: '◎ 팔뚝의 꼬리표가 미약하게 반짝인다. 값이 매겨진 증거처럼.' },
    { hour: 15, text: '◎ 뼈와 숨결, 심장의 박자가 종이 위로 옮겨진다.' },
    { hour: 18, text: '◎ 불이 낮아진다. 꽃밥 같은 어둠.' },
    { hour: 21, text: '◎ 누구의 꿈도 소리를 내지 않는다.' },
    { hour: 24, text: '◎ 첫 바퀴가 돌았다. 알 속의 심장만이 답을 안다.' },
    { hour: 27, text: '◎ 다시 종이 울리고, 같은 그림자가 움직인다.' },
    { hour: 30, text: '◎ 창밖으로 먼 별빛. 혹은 먼 도시의 등불.' },
    { hour: 33, text: '◎ 헬멧 너머의 시선이 오래 머문다. 값어치가 있다는 뜻.' },
    { hour: 35, text: '◎ 문이 열릴 준비를 한다. 꽃도 언젠가는 피어야 하니까.' },
  ],
  BABY: [
    { hour: 0,  text: '◎ 첫 호흡. 공기가 너무 맑아서 한동안 기침했다.' },
    { hour: 3,  text: '◎ 흰 복도는 꽃잎 속을 걷는 듯했다. 끝이 보이지 않았다.' },
    { hour: 6,  text: '◎ 다시 기록되는 몸. 어제의 숫자와 비교된다.' },
    { hour: 9,  text: '◎ 식사가 달다. 어딘가에서 기른 단맛.' },
    { hour: 12, text: '◎ 멀리서 다른 꽃봉오리들이 울고 있다.' },
    { hour: 18, text: '◎ 누군가 이름을 불러주었다. 그게 내 이름인지는 모르겠다.' },
    { hour: 24, text: '◎ 하루를 살아냈다는 건, 그만큼 값이 올랐다는 뜻.' },
    { hour: 30, text: '◎ 같은 방의 아이는 붉은 땅에서 왔다고 한다. 나와 같은 빛의 먼지.' },
    { hour: 36, text: '◎ 꿈에서 붉은 흙의 냄새를 맡았다. 아버지의 손톱 밑 냄새.' },
    { hour: 42, text: '◎ 장난감이 놓였다. 손에 쥐는 것도 일이라는 걸 배운다.' },
  ],
  CHILD: [
    { hour: 0,  text: '◎ 입에서 처음으로 말이 피어난다. 시킨 대로 정확하게.' },
    { hour: 6,  text: '◎ 같은 땅의 아이와 이름을 나눴다. 나눌 것이 그것뿐이라.' },
    { hour: 12, text: '◎ 다른 아이가 그릇을 비우지 않았다. 그것도 기록된다.' },
    { hour: 18, text: '◎ 개인 방으로 불려갔다. 나올 땐 기억 한 귀퉁이가 얇아졌다.' },
    ...
    { hour: 54, text: '◎ 종이 위에 같은 몸이 여러 번 옮겨진다. 적힐수록 얇아진다.' },
    { hour: 60, text: '◎ 헬멧이 한 번 벗겨졌다. 그 얼굴은 흔한 얼굴이었다.' },
    { hour: 66, text: '◎ 세 바퀴가 돌았다. 저울이 한 번 더 나를 읽는다.' },
    { hour: 70, text: '◎ 다음 피는 꽃을 기다린다. 내가 다음일까.' },
  ],
  TEEN: [
    { hour: 0,  text: '◎ 잎이 길어진다. 그만큼 가지런히 잘릴 준비도.' },
    { hour: 6,  text: '◎ 붉은 땅에서 오던 사슬이 가늘어졌다. 혹은 내가 멀어졌다.' },
    { hour: 12, text: '◎ "왜 여기에 있을까." 아무도 대답하지 않았다.' },
    { hour: 18, text: '◎ 관리자의 손이 멈췄다. 기록지 위에서. 오래.' },
    { hour: 24, text: '◎ 매 끼니가 여전히 달다. 단 건 원래 수상한 법이다.' },
    { hour: 30, text: '◎ 어떤 몸은 값이 나가고, 어떤 몸은 그렇지 않다.' },
    { hour: 36, text: '◎ 밤의 복도에서 바퀴 구르는 소리. 누군가가 다른 방으로 갔다.' },
    { hour: 42, text: '◎ 네 바퀴가 돌았다. 또래의 얼굴에 가시가 돋기 시작했다.' },
    { hour: 48, text: '◎ 같은 땅의 아이와 마주보았다. "우리, 진열대 위지?"' },
    { hour: 54, text: '◎ 붉은 땅에서 세 번째 침묵이 왔다.' },
    { hour: 60, text: '◎ 새 기계가 방에 들어왔다. 나를 읽는 방식이 달라졌다.' },
    { hour: 66, text: '◎ 창밖의 풍경이 어제와 다르다. 혹은 처음부터 그림이었을지도.' },
    { hour: 72, text: '◎ 이름 하나가 명단에서 조용히 지워졌다.' },
    { hour: 78, text: '◎ "곧 자리를 찾을 거야." 관리자의 목소리가 부드럽다.' },
    { hour: 84, text: '◎ 근육, 머리, 마음 — 셋 중 하나로 값이 매겨진다고 들었다.' },
    { hour: 90, text: '◎ 다섯 바퀴. 저울의 바늘이 내 숫자를 확정한다.' },
  ...
  ADULT: [
    ...
    { hour: 30, text: '◎ "붉은 땅의 기회를 쫓던 이름." 종이 위에 내가 그렇게 적혀 있다.' },
    { hour: 36, text: '◎ 같은 땅의 아이가 먼저 불려갔다. 꽃잎 한 장이 먼저 떨어졌다.' },
    { hour: 42, text: '◎ 훈련의 끝. 남은 숫자가 나의 이름을 대신한다.' },
    { hour: 48, text: '◎ 일곱 바퀴. 문이 열리거나, 닫히거나.' },
    { hour: 54, text: '◎ 오래된 종이에 붉은 땅의 이름들이 적혀 있다. 아버지도 그 안에.' },
